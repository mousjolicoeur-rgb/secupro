  ...
  return (
    <>
      ...
      <style>{`
        ...
        .sp-divider { height: 1px; background: linear-gradient(to right, transparent, rgba(0,170,255,0.2), transparent); margin: 0 2rem; }
        .sp-stat-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(0,170,255,0.15); border-radius: 14px; padding: 1.2rem 1rem; text-align: center; position: relative; overflow: hidden; }
      ...
      <div className="sp-root">
        ...
        <div style={{ textAlign: 'center', padding: '2rem 2rem 1rem' }}>
          ...
          <h1 style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: 'clamp(2rem,5vw,3.2rem)', fontWeight: 700, lineHeight: 1.1, marginBottom: '1rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '1rem', padding: '0.5rem 2rem 2rem' }}>
          {[
            ...
            <div key={i} className={`sp-stat-card ${s.color}`}>
              <div style={{ fontFamily: "'Rajdhani', sans-serif", fontSize: '1.8rem', fontWeight: 700, color: s.color === 'green' ? '#00e8a0' : s.color === 'orange' ? '#ffab40' : s.color === 'red' ? '#ff6b6b' : s.color === 'purple' ? '#b98aff' : '#0af', lineHeight: 1 }}>{s.num}</div>
        ...
        <div style={{ padding: '2rem 2rem 1rem' }}>
          ...
          <div style={{ fontSize: '0.82rem', color: 'rgba(255,255,255,0.35)', marginBottom: '1rem' }}>Manquements relevés lors des contrôles — Source CNAPS 2025</div>
          {[
          ...
          <div style={{ fontSize: '0.65rem', color: 'rgba(255,255,255,0.2)', padding: '0.5rem 0' }}>Source : CNAPS — Rapport annuel 2025 · Constats lors des contrôles terrain</div>
        </div>
        ...
        {/* FOUNDER */}
        <div style={{ background: 'rgba(255,255,255,0.02)', borderLeft: '3px solid #0af', borderRadius: '0 10px 10px 0', padding: '1rem 1.2rem', margin: '0 2rem 2rem', fontSize: '0.85rem', color: 'rgba(255,255,255,0.55)', lineHeight: 1.7, fontStyle: 'italic' }}>
        ...
        {/* ACCESS CHOICE */}
        <div style={{ padding: '2.5rem 2rem 3rem', background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(0,170,255,0.12)' }}>
          ...
          <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/agent/landing" className="sp-access-card agent" style={{ flex: 1, minWidth: '240px', maxWidth: '300px', textDecoration: 'none', display: 'block' }}>
