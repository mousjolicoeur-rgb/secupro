...
export default function EspaceSocietePage() {
  ...
  return (
    ...
    >
      ...
      {/* ══ CARTE ════════════════════════════════════════════════════════ */}
      <div
        className="relative w-full max-w-[420px] rounded-2xl px-8 py-9"
        style={{
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4 mb-7">
          ...
          <div className="text-center">
            ...
            <h1 className="text-[1.6rem] font-black leading-none tracking-tight">
              AUTHENTIFICATION{" "}
              <span
                style={{
                  color: CYAN,
            ...
            <p className="text-[9px] font-semibold mt-2 uppercase tracking-[0.25em]"
              style={{ color: "rgba(0,209,255,0.35)" }}>
              Accès Command Center — Données chiffrées AES-256
            </p>
          </div>
        </div>
