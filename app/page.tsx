        ...
        <div style={{ padding: '3rem 2rem', background: 'rgba(0,0,0,0.3)', borderTop: '1px solid rgba(0,170,255,0.12)' }}>
          <div style={{ maxWidth: '900px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              <Link href="/agent/login" className="sp-access-card agent" style={{ flex: 1, minWidth: '240px', maxWidth: '300px', textDecoration: 'none', display: 'block' }}>
              ...
              <Link href="/login" className="sp-access-card societe" style={{ flex: 1, minWidth: '240px', maxWidth: '300px', textDecoration: 'none', display: 'block' }}>
                <span style={{ fontSize: '2.8rem', marginBottom: '1rem', display: 'block' }}>🏢</span>
